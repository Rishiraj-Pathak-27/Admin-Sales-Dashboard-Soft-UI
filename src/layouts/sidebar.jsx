...
//         "gap-3" // Increased gap for more vertical space
...
//         )}
//       </div>
//       <div className="flex w-full flex-col gap-y-6 overflow-y-auto overflow-x-hidden p-5 [scrollbar-width:_thin]">
...
//                 {navbarLink.title}
//               </p>
//               {/* Dropdown for E Commerce Users */}
//               {navbarLink.title === "E Commerce Users" && (
//                 <div className="relative ml-2 group">
//                   <button
//                     className="flex items-center px-2 py-1 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition"
//                     tabIndex={0}
//                   >
//                     <svg
//                       width="16"
...
//                     </svg>
//                   </button>
//                   <div className="absolute left-0 mt-2 w-40 rounded-md shadow-lg bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity z-50">
//                     <ul className="py-1">
//                       <li>
//                         <a
//                           href="#"
...
//                     "mb-6", // Increased margin for more vertical space
...
//                 </span>
//                 {!collapsed && <p className="">{link.label}</p>}
//               </NavLink>
//             ))}
//           </nav>
//         ))}
    ...
    >
        <div className="flex items-center gap-x-3 p-5">
            <img
                ...
                className="dark:hidden object-contain h-10"
            />
            {/* Uncomment below if you have a dark logo */}
            {/* <img
                    src={logoDark}
                    alt="Logoipsum"
                    className="hidden dark:block object-contain h-10"
        ...
        {/* Main navigation content - with flex-1 to take available space */}
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                cn(
                                    ...
                                    collapsed && "md:w-[65px] justify-center",
                                    isActive ? "font-normal" : "font-normal",
                                    "mb-2", // Reduced margin from mb-6 to mb-2
                                    "transition-all duration-200 ease-in-out",
                                    "hover:bg-gray-100 dark:hover:bg-gray-800",
                                    "relative",
                                    "before:content-[''] before:absolute before:inset-0 before:-z-10 before:rounded-lg before:scale-110 before:opacity-0 hover:before:opacity-100 before:bg-gray-100 dark:before:bg-gray-800 before:transition-all before:duration-200 before:ease-in-out"
                    ...
                    <div className="absolute bottom-full left-[-106px] mb-2 w-40 rounded-md shadow-lg text-center bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 z-50">
                        <div className="py-1">
                            {languages.map((language) => {
                                // Assign different images for each language
                                let imgSrc;
                                ...
                                return (
                                    ...
                                    >
                                        {/* Different image in front of each language */}
                                        <img
                                            src={imgSrc}
                                            alt={language.name}
