...
return (
    ...
    >
        ...
        <div className={cn(
            ...
            collapsed ? "flex flex-col items-center gap-3" : "flex items-center justify-center gap-2"
        )}>
            ...
            <div className="relative">
                ...
                {isLanguageDropdownOpen && (
                    <div className="absolute bottom-full left-[-100px] mb-2 w-40 rounded-md shadow-lg text-center bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 z-50">
                        <div className="py-1">
